                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12"> <span class="heading-meta style-1">Blog</span>
                            <h2 class="lonon-post-heading animate-box" data-animate-effect="fadeInLeft">Responsive HTML5 Frameworks</h2> </div>
                    </div>
                    <div class="row">
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img class="avatar photo" src="images/blog/people01.jpg" alt="">
                                                    <h3 class="name">Ben Handson</h3> </div>
                                                <div class="comment-meta"> Dec 28, 2019 </div>
                                            ...
                                            <ol class="children">
                                                <li class="comment odd parent">
                                                    <div class="comment-body">
                                                        <div class="comment-author vcard"> <img class="avatar photo" src="images/blog/people02.jpg" alt="">
                                                            <h3 class="name">Ayla Glenn</h3> </div>
                                                        <div class="comment-meta"> Dec 27, 2019 </div>
                                        ...
                                        <li class="comment">
                                            <!-- comment block -->
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img class="avatar photo" src="images/blog/people04.jpg" alt="">
                                                    <h3 class="name">Emily Smith</h3> </div>
                                                <div class="comment-meta"> Sep 27, 2019 </div>
                                                <p>Yuroin non lorem ac erat suscipit bibendum. Nulla facilisi. Sedeuter nunc volutpat, mollis sapien veli, conseyer turpeutionyer massa in libero semper sedeuter nunc volutpat, mollis sapien veletion. Quisque gravida eros ut turpis interdum ornare. Interdum et malesu they adamale fames ac ante ipsum primis in faucibus. Curabitur arcu erosite feugiat in tortor in, volutpat sollicitudin libero.</p>
                                                <div class="reply"> <a href="#" class="comment-reply-link"><i class="ti-back-left"></i> Replay</a> </div>
                                            </div>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <!-- Leave a comments -->
                            <h3 class="lonon-about-heading">Leave a Comments</h3>
